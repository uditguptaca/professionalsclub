    ...
    <>
      ...
      <section style={{ position: 'relative', paddingTop: 140, paddingBottom: 100, background: 'var(--text-primary)', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', inset: 0 }}>
          <Image src="/volunteer-help.webp" alt="How it works" priority fill sizes="100vw" style={{ objectFit: 'cover', opacity: 0.2 }} />
        ...
        <div className="container" style={{ position: 'relative', zIndex: 10, maxWidth: 900, textAlign: 'center' }}>
          <h1 style={{ fontSize: '3.4rem', fontWeight: 900, color: 'white', fontFamily: 'var(--font-display)', marginBottom: 20, lineHeight: 1.15 }}>
            How the Help Desk <span style={{ color: 'var(--text-accent)' }}>Works</span>
          </h1>
      ...
      <section style={{ padding: '40px 0', background: 'var(--bg-primary)' }}>
        <div className="container" style={{ maxWidth: 1000 }}>
          <div style={{ textAlign: 'center', marginBottom: 32 }}>
            <div style={{ width: 56, height: 56, borderRadius: 16, background: 'var(--primary-50)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto', color: 'var(--text-accent)' }}><Target size={28} /></div>
      ...
      <section style={{ padding: '40px 0', background: 'var(--bg-secondary)', borderTop: '1px solid var(--border-color)' }}>
        <div className="container" style={{ maxWidth: 1200 }}>
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            <div style={{ width: 56, height: 56, borderRadius: 16, background: 'var(--primary-50)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto', color: 'var(--text-accent)' }}><HandHeart size={28} /></div>
      ...
      <section style={{ padding: '40px 0', background: 'var(--text-primary)', textAlign: 'center' }}>
        <div className="container" style={{ maxWidth: 600 }}>
          ...
          <p style={{ fontSize: '1.1rem', color: 'rgba(255,255,255,0.82)', marginBottom: 20 }}>Ask for help today — a real person will get back to you.</p>
          <div style={{ display: 'flex', justifyContent: 'center', gap: 16 }}>
            <Link href="/portal/auth" className="btn btn-primary btn-lg" style={{ padding: '16px 36px', background: 'var(--primary-700)', border: 'none', boxShadow: '0 8px 24px rgba(232,93,4,0.3)' }}>Request Help <ArrowRight size={18} /></Link>
