    ...
    <>
      ...
      <section style={{ position: 'relative', paddingTop: 140, paddingBottom: 100, background: 'var(--text-primary)', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', inset: 0 }}>
          <Image src="/toronto-skyline.webp" alt="Toronto" priority fill sizes="100vw" style={{ objectFit: 'cover', opacity: 0.15 }} />
              ...
              return (
                <div key={article.id} style={{ position: 'relative', height: 380, borderRadius: 24, overflow: 'hidden', boxShadow: '0 10px 25px rgba(0,0,0,0.15)' }}>
                  ...
                  <div style={{ position: 'absolute', top: 24, left: 24, display: 'flex', alignItems: 'center', gap: 8 }}>
                    <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 32, height: 32, borderRadius: '50%', background: 'rgba(255,255,255,0.2)', color: 'white', backdropFilter: 'blur(8px)', border: '1px solid rgba(255,255,255,0.3)' }}>
