...
const CATEGORIES = [
  {
    ...
    files: [
      ...
      { name: 'Document List - A Newcomer\'s Complete Guide', type: 'PDF Document', size: 'Download', url: 'https://raw.githubusercontent.com/uditguptaca/professionalsclub/main/Document-List-you-should-bring-with-yourself-to-Canada-%E2%80%93-A-Newcomers-complete-guide-.pdf' }
