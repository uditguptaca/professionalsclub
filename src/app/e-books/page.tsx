                      ...
                      {category.files.length > 0 ? (
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                          {category.files.map((file, idx) => {
                            const githubUrl = \`https://raw.githubusercontent.com/uditguptaca/professionalsclub/main/\${file.url}\`;
                            const viewerUrl = \`https://docs.google.com/viewer?url=\${encodeURIComponent(githubUrl)}&embedded=true\`;
                            return (
                              <a
                                key={idx}
