...
const CATEGORIES = [
  {
    ...
    gradientFrom: '#2563eb',
    gradientTo: '#3b82f6',
    description: 'Essential steps to take before you leave your home country. These guides cover documentation, financial planning, and packing essentials to ensure a smooth transition.',
    files: [
      { name: 'Documentation Checklist', type: 'PDF Document', size: 'Download', url: 'https://raw.githubusercontent.com/uditguptaca/professionalsclub/main/Documentation%20Checklist.pdf' },
      { name: 'Pre-Departure Guide', type: 'PDF Document', size: 'Download', url: 'https://raw.githubusercontent.com/uditguptaca/professionalsclub/main/Predeparture-checklist-for-newcomers-to-Canada-1.pdf' },
  ...
  },
  {
    ...
    files: [
      ...
      { name: 'Getting your SIN Card', type: 'PDF Document', size: 'Download', url: 'https://raw.githubusercontent.com/uditguptaca/professionalsclub/main/Getting-Social-Insurance-Number-SIN-as-a-newcomer-in-Canada-1.pdf' },
