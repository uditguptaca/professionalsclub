...
export default function DonatePage() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: 'white' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 10, maxWidth: 1200 }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
            <div style={{ maxWidth: 640 }}>
              <h1 style={{ fontSize: '2.5rem', fontWeight: 800, lineHeight: 1.25, fontFamily: 'var(--font-display)', marginBottom: 24 }}>
                Professionals Club is a broad-based association supporting a variety of professions in Canada, including CPAs, doctors, engineers, MBAs, marketers, educators, IT professionals, and tradespeople.
              </h1>
              <p style={{ fontSize: '1.05rem', color: '#cbd5e1', lineHeight: 1.6, marginBottom: 32 }}>
                Our organization aids individuals from diverse fields in navigating their careers and thriving in the Canadian workplace.
              </p>
            ...
            <div style={{ display: 'flex', gap: 32, justifyContent: 'flex-end' }}>
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: '3.5rem', fontWeight: 300, lineHeight: 1 }}>2,000+</div>
                <div style={{ fontSize: '0.85rem', fontWeight: 700, marginTop: 8 }}>Members</div>
              </div>
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: '3.5rem', fontWeight: 300, lineHeight: 1 }}>100+</div>
                <div style={{ fontSize: '0.85rem', fontWeight: 700, marginTop: 8 }}>Volunteers</div>
              </div>
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: '3.5rem', fontWeight: 300, lineHeight: 1 }}>40+</div>
      ...
      <main style={{ flex: 1, padding: '80px 0', background: '#f8fafc' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64 }}>
            ...
            <div style={{ padding: '40px 0' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
                <div style={{ fontSize: '2.5rem', fontFamily: 'serif', color: '#0f172a' }}>Udit Gupta</div>
                <div>
                  <div style={{ fontWeight: 800, color: '#1e293b', fontSize: '0.9rem' }}>Udit Gupta</div>
                  <div style={{ fontSize: '0.8rem', color: '#64748b' }}>Founder, CEO & Director<br/>Professionals Club</div>
                </div>
              </div>
            </div>
