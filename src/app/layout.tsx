  ...
  return (
    <html lang="en" data-scroll-behavior="smooth" suppressHydrationWarning className={`${fraunces.variable} ${manrope.variable} ${mono.variable}`}>
      {/* suppressHydrationWarning (html + body): inside the native shell,
          ...
          52px on a notched phone). The server cannot know those values, so
          without this React reports a hydration mismatch on every native
          launch. Only these elements' attributes are exempted — children are
          still checked. */}
