...
const COMMUNITIES: CommunitySection[] = [
  ...
  },
  {
    ...
    groups: [
      ...
      { icon: <Building2 size={20} />, name: 'CA Community in Canada Group 2', link: 'https://bit.ly/ICPCA2' },
      { icon: <MapPin size={20} />, name: 'CA Community in Vancouver — Meetups & Jobs', link: 'https://bit.ly/ICPvancouver' },
      { icon: <Mountain size={20} />, name: 'CA Community in Alberta — Meetups & Jobs', link: 'https://bit.ly/ICPalberta' },
      { icon: <Landmark size={20} />, name: 'CA Community in Ottawa — Meetups & Jobs', link: 'https://bit.ly/ICPottawa' },
      { icon: <Home size={20} />, name: 'CA Community in Quebec — Meetups & Jobs', link: 'https://bit.ly/ICPquebec' },
      { icon: <FileText size={20} />, name: 'CA Community in Ontario — Jobs, Queries & Help', link: 'https://bit.ly/ICPOntario' },
  ...
  },
  {
    ...
    groups: [
      ...
      { icon: <CircleDot size={20} />, name: 'Odisha क जगन्नाथ Puri', link: 'https://bit.ly/ICPOdisha' },
...
export default function GroupsPage() {
  return (
    <>
          ...
          <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: 60, flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: '1 1 500px', textAlign: 'left' }}>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'rgba(232,93,4,0.15)', padding: '6px 16px', borderRadius: 99, marginBottom: 24, border: '1px solid rgba(232,93,4,0.3)' }}>
                <MessageCircle size={14} style={{ color: 'var(--primary-200)' }} />
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-start', gap: 40, marginTop: 24 }}>
                {[
                  ...
                  <div key={i}>
                    ...
                    <div style={{ fontSize: '0.75rem', color: 'var(--primary-400)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.08em' }}>{s.label}</div>
                  </div>
                ))}
              </div>
            </div>
      ...
      {/* ─── QUICK NAV ─── */}
      <section style={{ padding: '30px 0', background: 'var(--bg-primary)', borderBottom: '1px solid var(--border-color)', position: 'sticky', top: 0, zIndex: 40, backdropFilter: 'blur(12px)', backgroundColor: 'rgba(255,255,255,0.95)' }}>
      ...
      {COMMUNITIES.map((community, idx) => (
        <section
          ...
          style={{
            padding: '80px 0',
            background: idx % 2 === 0 ? 'var(--primary-50)' : 'white',
            scrollMarginTop: 100,
          }}
        >
          <div className="container" style={{ maxWidth: 1280 }}>
              ...
              {community.groups.map((group, gi) => (
                <a
                  ...
                  onMouseOver={(e: React.MouseEvent<HTMLAnchorElement>) => { 
                    (e.currentTarget as HTMLElement).style.borderColor = 'var(--primary-600)'; 
                    (e.currentTarget as HTMLElement).style.boxShadow = `0 4px 14px rgba(232,93,4,0.15)`; 
        ...
        <div className="container" style={{ position: 'relative', zIndex: 10, maxWidth: 700, textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: 16, flexWrap: 'wrap' }}>
            <Link href="/portal/signup" className="btn btn-lg" style={{
              ...
              padding: '16px 36px',
              fontSize: '1.05rem',
              boxShadow: '0 8px 30px rgba(232,93,4,0.35)',
            }}>
